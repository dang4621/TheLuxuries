                ...
                <div class="col-md-12">
                    <div class="card card-plain">
                        ...
                        <div class="contact-form">
                            ...
                            <form action="index.php?act=update_dm" method="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );">
                                <p>
                                    <b>MÃ LOẠI</b><br>
                                ...
                                <p>
                                    ...
                                    <input type="text" name="ten_dm" value="<?php echo($ten_nhom_hang) ?>"
                                        style="width:100%;">
                                </p>
                                </p>
                                <br>
