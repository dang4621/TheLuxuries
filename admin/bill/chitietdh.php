<div class="main-panel">
    ...
    <div class="full-height-section error-section">
        <div class="full-height-tablecell">
            <div class="container" style="position:relative;left:22%">
                <div class="row">
                    <div class="order-track container-fluid">
                        <div class="group">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 group-right calculate" style="width:100%;">
                                <div class="media22" style="width:49.8%;">
                                    <div class="media-body">
                                        ...
                                        <h4><span class="pleft">Phí giao hàng:</span><span
                                                class="pright bold"><?php echo $phi_ship;?>
                                                <span>VNĐ</span></span>
                                        </h4>
                                        ...
                                        <h4>
                                            <span class="pleft ">Tổng thanh toán:</span><span
                                                class="pright bold"><?php echo $thanh_tien + $phi_ship ; ?>
                                                <span>VNĐ</span></span>
                                        </h4>
                                        <br>
                                    </div>
        ...
        <div class="butn">
            <a href="index.php?act=sua_tt&ma_hoa_don=<?= $so_hoa_don ?>&tt=1">Đang chuẩn bị
                hàng</a>
            <a href="index.php?act=sua_tt&ma_hoa_don=<?= $so_hoa_don ?>&tt=2">Đang giao</a>
            <a href="index.php?act=sua_tt&ma_hoa_don=<?= $so_hoa_don ?>&tt=3">Đã giao</a>
